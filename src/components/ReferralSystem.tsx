  ...
  return (
      <div className="">
        ...
        */}
            ...
            <p className="text-sm font-medium text-gray-700">Exisem 3 maneiras de Indicar o Club8 e poder ganhar bonificações.</p>
            <div className="text-sm mb-0">
              1. Você pode copiar o seu número de cliente acima, e pedir para o seu “indicado” usar o mesmo no
              campo de indicação no cadastro.
            </div>
            <div className="text-sm" style={{ marginTop: '0.3rem' }}>
              2. Copiar o link acima, e enviar para que a pessoa use o mesmo para acessar a plataforma e fazer o
              cadastro.
            </div>
            <div className="text-sm" style={{ marginTop: '0.3rem' }}>
              3. Clicar no botão Compartilhar Link e escolher uma das opções de envio.
              Lembre-se, você só será bonificado quando sua indicação investir num dos planos do Club8.
              Veja as regras completas sobre indicação <a href="/termos-de-uso">Clicando Aqui</a>.
            </div>
          </div>
        </Card>
